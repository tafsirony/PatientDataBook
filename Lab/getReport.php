...
$sql = "SELECT Test_type,t.T_Name,TW_Normal,TW_Abnormal,TW_Flag,TW_Reference_Range,Tw_Date,d.D_Name,tw.Tw_Date FROM test_writen tw RIGHT JOIN test t ON t.T_Id=tw.T_Id RIGHT JOIN patient p ON p.P_Id=t.P_Id JOIN doctor d ON d.D_Id=t.D_Id WHERE p.P_Mail_Id= '".$email."'AND 
